if game.GameId == 0 then
	...
	local Window = DeleteMobLib:CreateWindow(HyperEscape.GUI.GUIToggleKey, "pf.lol");
	...
	SettingsInfoSector:CreateCoppyText("Made By Cole");
	SettingsInfoSector:CreateCoppyText("https://discord.gg/gDXdZUkA - Click Me");
	...
	local UIStroke = Instance.new("UIStroke")UIStroke.Color = Color3.fromRGB(100,0,100) UIStroke.Parent = FOVFFrame UIStroke.Thickness = 1 UIStroke.ApplyStrokeMode = "Border"; game:GetService("StarterGui"):SetCore("SendNotification", {Title = "https://discord.gg/gDXdZUkA", Text = "The Discord For More!"});
